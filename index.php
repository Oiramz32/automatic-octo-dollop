...
<div class="row">
	...
	<p><b>Check Date</b></p><hr class="line">
			...
			<div class="row">
			  ...
			  <div class="row">
				<div class="large-12 columns" >
					<button name="submit" href="#" class="button small fontslabo" style="background-color:#FFA500; width:100%; color:black;" >Check Availability</button>
				</div>
				<div class="large-12 columns" >
					<a href="admin/index.htm" class="button small fontslabo" style="background-color:#FFA500; width:100%; color:black;">Log In</a>
                </div>
			  </div>
			</form>
	</div>
